...
//    private final CompanyUserJpaRepository boardJpaRepository;
//
//    /**
//     * 게시글 저장
//     */
...
//    @Transactional
//    public CompanyUser save(CompanyUserRequest.SaveDTO saveDTO, User sessionUser) {
...
//        CompanyUser board = saveDTO.toEntity(sessionUser);
...
//        List<CompanyUser> boardList = boardJpaRepository.findAllJoinUser();
...
//        CompanyUser board = boardJpaRepository.findByIdJoinUser(id).orElseThrow(() -> {
...
//     */
//    @Transactional
//    public CompanyUser updateById(Long id, CompanyUserRequest.UpdateDTO updateDTO, User sessionUser) {
//        // 1. 로그 기록
//        // 2. 수정할 게시글 조회
//        // 3. 권한 체크
//        // 4. 권한이 없다면 403 에러 처리
...
//        CompanyUser board = boardJpaRepository.findById(id).orElseThrow(() -> {
//            log.warn("게시글 조회 실패 - id {}", id);
...
//        CompanyUser board = findById(boardId);
