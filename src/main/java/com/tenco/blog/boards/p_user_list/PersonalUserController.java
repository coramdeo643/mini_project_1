...
public class PersonalUserController {
    ...
    private static final Logger log = LoggerFactory.getLogger(PersonalUserController.class);
    private final PersonalUserService boardService;
    ...
    public String update(@PathVariable(name = "id") Long id,
                         PersonalUserRequest.UpdateDTO reqDTO,
                         HttpSession session) {
        // 1. 인증 검사
        // 2. 데이터 유효성 검사
        // 3. 수정 요청 Service 위임
    ...
    public String save(PersonalUserRequest.SaveDTO reqDTO, HttpSession session) {
        // 1. 인증 검사
        // 2. 유효성 검사
        // 3. Service 위임
        reqDTO.validate();
    ...
    public String index(Model model) {
        List<PersonalUser> boardList = boardService.findAll();
