...
//
//    private static final Logger log = LoggerFactory.getLogger(CompanyPostService.class);
//    private final CompanyPostJpaRepository boardJpaRepository;
//
//    /**
//     * 게시글 저장
//     */
...
//    @Transactional
//    public CompanyPost save(CompanyPostRequest.SaveDTO saveDTO, User sessionUser) {
...
//        CompanyPost board = saveDTO.toEntity(sessionUser);
...
//     * 게시글 목록 조회
//     */
//    public List<CompanyPost> findAll() {
//        // 1. 로그 기록
//        // 2. 데이터 베이스 게시글 조회
//        // 3. 로그 기록
//        // 4. 조회된 게시글 목록 반환
//        log.info("게시글 조회 서비스 처리 시작");
//        List<CompanyPost> boardList = boardJpaRepository.findAllJoinUser();
...
//     * 게시글 상세 조회
//     */
//    public CompanyPost findById(Long id) {
//        // 1. 로그 기록
...
//        CompanyPost board = boardJpaRepository.findByIdJoinUser(id).orElseThrow(() -> {
...
//     */
//    @Transactional
//    public CompanyPost updateById(Long id, CompanyPostRequest.UpdateDTO updateDTO, User sessionUser) {
//        // 1. 로그 기록
//        // 2. 수정할 게시글 조회
//        // 3. 권한 체크
//        // 4. 권한이 없다면 403 에러 처리
...
//        CompanyPost board = boardJpaRepository.findById(id).orElseThrow(() -> {
//            log.warn("게시글 조회 실패 - id {}", id);
...
//        CompanyPost board = findById(boardId);
